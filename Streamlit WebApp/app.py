...
st.info("This tool forecasts financial solvency using by modeling the growth of the population of pension contributor and recipients using the logistic function.")

# Sidebar inputs
st.sidebar.header('User Input Features')

t = st.sidebar.slider('T (Monthly)', 1, 36)
...
Ave_cont = st.sidebar.slider("Average Contribution per Person", 100.0, 1000.0)
...
Ave_pen = st.sidebar.slider("Average Pension per Person", 500.0, 10000.0)
